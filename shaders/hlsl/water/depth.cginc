...
half3 DepthRefraction(float2 waterTransparency, float2 waterDepthValues, float2 foamRanges, float3 horizontalExtinction,
	half3 refractionColor, half3 shoreColor, half3 surfaceColor, half3 depthColor)
{
	...
	float startShoreRange = min(foamRanges.x, foamRanges.y) * 0.5;
